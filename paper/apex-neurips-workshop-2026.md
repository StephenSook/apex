...
**The five shouldn't-be-possible moves.** Beyond the three-layer pipeline above, APEX stacks five composition moves that, individually, push the envelope of what a 12-day hackathon submission should ship; collectively, they form the technical risk-asymmetry argument for the submission. We name the five so the judging panel can reason about each independently.
