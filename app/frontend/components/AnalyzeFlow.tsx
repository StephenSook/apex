      ...
      <div className="mx-auto max-w-6xl px-6 pb-2 lg:px-10">
        <div className="flex flex-col gap-3 rounded-sm border border-rule bg-paper-warm p-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          <p className="text-sm leading-relaxed text-ink-soft">
            ...
            canonical reference session through the deployed APEX backend: a real
            differentiable-QP physics projection + COA-parsed simultaneity gate +
            a deterministic Guardian rule-audit, computed live. Falls back to an
            illustrative report if the backend is unreachable.
          </p>
          <button
            type="button"
