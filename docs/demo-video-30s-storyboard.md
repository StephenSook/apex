...
| 0:20 - 0:25 | Cut to the tuning-recommendation card UI alone, full-frame. "Reduce hand-lever brake travel by 4 millimetres" headline. CitationChip showing FIA Appendix L Article 18.3 + COA Section 3(c). Forecast envelope behind it shows recovery of 0.42 seconds. | "The recommendation cites her actual COA section. Every claim has provenance. Free at the point of use. Open source." | Cut from 3-min Beat 6 close. |
