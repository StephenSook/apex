...
Preview offer. The 3-minute demo video records on 2026-05-29 (Day 10) and uploads to the BeMyApp submission portal on 2026-05-31 (Day 12). I would be glad to send either of you a private preview link before the public release, so you can confirm the MME naming reads the way you would want it to before submission. If there is any wording you would prefer adjusted, I will adjust it before submission. If the preview is not needed, just let me know and I will not bother you again before the submission lands.

Optional. If either of you wanted to share a one-sentence reaction we could include in the project's deck acknowledgements (with full corporate attribution and no personal names unless you separately approve), I would credit MME Motorsport as the adaptive-equipment supplier reference for the persona. Completely optional. The consent grant you already gave is plenty.

Final note. The acknowledgement on public surfaces ("Thanks to MME Motorsport d.o.o. for granting per-surface attribution permission") will land in the video end-card, the deck Acknowledgements slide, and the README Acknowledgements section. If any of those acknowledgements would prefer different framing, please flag it before 2026-05-29 and I will adjust before the video record.

Thank you again for backing the project. The adaptive-racer community (Team BRIT, Mission Motorsport, Operation Motorsport, FFSA Handikart) deserves better AI tooling than what currently exists. APEX is our 12-day attempt at that bar, with the IBM Granite stack underneath and MME's real adaptive-equipment work as the credibility anchor.
...
- [ ] Sender + CC personal names appear only in the consent-log audit trail; this reply does not surface their names anywhere else.
- [ ] Preview-link path: if they accept, the YouTube unlisted URL gets shared via reply 2026-05-30 (Day 11 morning) once the video is on YouTube. If they decline or do not reply by 2026-05-29 EOD, ship the video without preview.
...
_Drafted 2026-05-22 by Stephen + Claude. Send within 24h of consent receipt to maintain professional reply cadence._
